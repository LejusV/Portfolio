...
const translations = {
  en: {
    ...
    cv_profile: "Born in February 2002, I graduated from ENSIMAG with a master's degree (Engineer Title) in computer science. Although I love computer science, I am always looking for some creativity in my daily work. That is why I chose to learn Computer Graphics in TUGraz in an amazing ERASMUS+ program.",
    ...
    project5: "Nebula Nomads - Unity 2D Game",
    project5_desc: "Fully group-developed 2D Unity game (free assets found on itch.io and modified), where you explore space with your spaceship, collect resources while trying to avoid obstacles and defeat enemies.",
    ...
    desc_project4_1: "2D character and its companion following it, all animated according to movement direction.",
    desc_project4_2: "In-game screenshot of the main scene, with a nice small area to explore, some UI buttons for debugging, a map and a clock. It is currently daytime in the game here.",
    desc_project4_3: "In-game screenshot of the battle scene. We are here selecting an object to use during the fight. We can see the sprite and it changes when hovering a different item.",
    desc_project4_4: "In-game screenshot of the main scene. It is now nighttime, showcasing the day-night cycle implemented in the game. The lighting has changed accordingly with darker tones.",
    desc_project4_5: "Zoomed-out view of a small area created for the occasion with the assets available in the project's framework, showing all sorts of obstacles and trigger elements.",
    desc_project4_6: "Zoomed-out view of an other area created with a lot of tall grass to trigger a fight with a wild creature.",
    desc_project5_1: "Gameplay video of a small 2D game made as a group of 4 people in Unity, where you explore space with your spaceship, collect resources while trying to avoid obstacles and defeat enemies.",
    desc_project5_2: "In-game screenshot showing the space scene with a magma planet.",
    desc_project5_3: "In-game screenshot showing the space scene with an icy planet.",
    desc_project5_4: "In-game screenshot showing the mining scene on the magma planet. There are obstacles to avoid and resources to collect.",
    desc_project5_5: "In-game screenshot showing the mining scene on the icy planet with different obstacles and resources.",
  ...
  fr: {
    ...
    cv_profile: "Né en février 2002, je suis diplômé Ingénieur en informatique de l'ENSIMAG. Bien que passionné d'informatique, je recherche toujours de la créativité dans mon quotidien. C'est pourquoi j'ai choisi d'étudier l'infographie à TUGraz dans le cadre d'un programme ERASMUS+ exceptionnel.",
    cv_languages_title: "Langues",
    cv_languages_main: "Français | Anglais TOEIC B2-C1",
    cv_languages_other: "Espagnol A2, Allemand, Chinois : Débutant",
    ...
    project5: "Nebula Nomads - Unity 2D Game",
    project5_desc: "Jeu 2D Unity entièrement développé en groupe (assets libres trouvés sur itch.io et modifiés), où l'on explore l'espace avec son vaisseau spatial, collecte des ressources tout en essayant d'éviter les obstacles et de vaincre des ennemis.",
    ...
    desc_project4_1: "Personnage 2D et son compagnon le suivant, le tout animé selon la direction de déplacement.",
    desc_project4_2: "Capture d'écran en jeu de la scène principale, avec une petite zone agréable à explorer, quelques boutons d'interface pour le débogage, une carte et une horloge. Il fait actuellement jour dans le jeu ici.",
    desc_project4_3: "Capture d'écran en jeu de la scène de combat. Nous sommes ici en train de sélectionner un objet à utiliser pendant le combat. On peut voir le sprite qui change lorsqu'on survole un objet différent.",
    desc_project4_4: "Capture d'écran en jeu de la scène principale. Il fait maintenant nuit, mettant en avant le cycle jour-nuit implémenté dans le jeu. L'éclairage a changé en conséquence avec des tons plus sombres.",
    desc_project4_5: "Vue dézoomée d'une petite zone créée pour l'occasion avec les assets disponibles dans le framework du projet, montrant un peu toute sorte d'obstacles et d'élements déclencheurs.",
    desc_project4_6: "Vue dézoomée d'une autre zone créée avec beaucoup de hautes herbes pour déclencher un combat avec une créature sauvage.",
    desc_project5_1: "Vidéo de gameplay d'un petit jeu 2D réalisé en groupe de 4 personnes sous Unity, où l'on explore l'espace avec son vaisseau spatial, collecte des ressources tout en essayant d'éviter les obstacles et de vaincre des ennemis.",
    desc_project5_2: "Capture d'écran en jeu montrant la scène spatiale avec une planète de magma.",
    desc_project5_3: "Capture d'écran en jeu montrant la scène spatiale avec une planète glacée.",
    desc_project5_4: "Capture d'écran en jeu montrant la scène de minage sur la planète de magma. Il y a des obstacles à éviter et des ressources à collecter.",
    desc_project5_5: "Capture d'écran en jeu montrant la scène de minage sur la planète glacée avec différents obstacles et ressources.",
